...
(function (g) {
  ...
  const SPEC = [
    ...
    ['consumer-staples', 'charts', 'price-vs-volume', 'priceCostSpread', { quarters: 8, fill: false }],
    ['consumer-staples', 'figures', 'net-sales-walk', 'walkN', { cols: 6 }],
    ['health-care', 'structure', 'exclusivity-runway', 'cashConversionCycle',
      { ticks: 6, bands: [['band-1'], ['band-2'], ['band-3']], bandScale: [2025, 2040], scale: { years: [2025, 2040], why: 'fixed, so every product is read on one calendar' },
